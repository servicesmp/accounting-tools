...
export declare const DOCUMENT_LANGUAGES: readonly DocumentLanguage[];
/**
 ...
 */
export type DocumentStatus = 'draft' | 'pending' | 'paid' | 'accepted' | 'rejected' | 'cancelled' | 'expired' | 'overdue' | 'refunded';
...
export declare const FRAME_LAYOUTS: readonly FrameLayout[];
export declare const PARTIES_LAYOUTS: readonly PartiesLayout[];
export declare const TABLE_LAYOUTS: readonly TableLayout[];
export declare const TOTALS_LAYOUTS: readonly TotalsLayout[];
export declare const LOGO_LAYOUTS: readonly LogoLayout[];
...
export declare const COLUMN_KEYS: readonly ColumnKey[];
export declare const REQUIRED_COLUMNS: readonly ColumnKey[];
...
export interface DocumentData {
    ...
    readonly extraCharges?: readonly {
...
export interface DocumentView {
    ...
    readonly totalsRaw: DocumentTotals & {
