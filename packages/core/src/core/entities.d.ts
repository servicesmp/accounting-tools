...
export declare class InvoiceLine implements IInvoiceLine {
    ...
    constructor(id: string, description: string, quantity: number, unitPrice: number, vatRate: number, taxCategoryCode?: string, unitCode?: string, billingPeriodStart?: Date | undefined, billingPeriodEnd?: Date | undefined, deliveredQuantity?: number | undefined, productId?: string | undefined, ean?: string | undefined, taxExemptionReason?: string | undefined, taxExemptionReasonCode?: string | undefined);
