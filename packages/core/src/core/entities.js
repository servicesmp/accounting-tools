...
class InvoiceLine {
    constructor(id, description, quantity, unitPrice, vatRate, taxCategoryCode = 'S', unitCode = 'C62', billingPeriodStart, billingPeriodEnd, deliveredQuantity, productId, ean, taxExemptionReason, taxExemptionReasonCode) {
        this.id = id;
